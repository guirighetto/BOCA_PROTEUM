...
public interface vhdlListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterName_attribute_part(vhdlParser.Name_attribute_partContext ctx);
	/**
	 * Exit a parse tree produced by {@link vhdlParser#name_attribute_part}.
	 * @param ctx the parse tree
	 */
	void exitName_attribute_part(vhdlParser.Name_attribute_partContext ctx);
	/**
	 * Enter a parse tree produced by {@link vhdlParser#name_function_call_or_indexed_part}.
	 * @param ctx the parse tree
	 */
	void enterName_function_call_or_indexed_part(vhdlParser.Name_function_call_or_indexed_partContext ctx);
	/**
	 * Exit a parse tree produced by {@link vhdlParser#name_function_call_or_indexed_part}.
	 * @param ctx the parse tree
	 */
	void exitName_function_call_or_indexed_part(vhdlParser.Name_function_call_or_indexed_partContext ctx);
	/**
	 * Enter a parse tree produced by {@link vhdlParser#name_slice_part}.
	 * @param ctx the parse tree
	 */
	void enterName_slice_part(vhdlParser.Name_slice_partContext ctx);
	/**
	 * Exit a parse tree produced by {@link vhdlParser#name_slice_part}.
	 * @param ctx the parse tree
	 */
	void exitName_slice_part(vhdlParser.Name_slice_partContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterRange(vhdlParser.RangeContext ctx);
	/**
	 * Exit a parse tree produced by {@link vhdlParser#range}.
	 * @param ctx the parse tree
	 */
	void exitRange(vhdlParser.RangeContext ctx);
	/**
